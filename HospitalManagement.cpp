...
#include<string.h>
#include<stdlib.h>
  #define MAXPATIENTS 100      //define maximum number of patients
struct patient                                   // define structure for patient data
{
char FirstName[50];
char LastName[50];
char ID[20];
 ...
 class queue                                     // define class for queue
 {
 public:
 queue (void);
 ...
 };                                               // declared member functions for queue
...
int queue::AddPatientAtEnd (patient p) // adds a patient at the end 
{
